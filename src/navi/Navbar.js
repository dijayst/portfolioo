    ...
    return (
      ...
      <div className="sidebar">
         ...
         <header className="header_section">
            <div className="nav-container">
               <nav className="navbar navbar-expand-lg custom_nav-container ">
               <GrClose onClick={closeMobileMenu}/>
             <div  className={click ? 'nav-menu active' : 'nav-menu'}>
              <div className="divimg">
           <img src={ster}  className="imgea1" alt="hrk" height="170px" width="170px"/>
          <br/>
          ...
          <p>frontend developer in Nigeria  <GrClose onClick={closeMobileMenu}/></p>
              </div>
                  <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <br/><br/>
                     <ul>
            ...
            >
              Dashboard <i className='fas fa-caret-down' />
                       ...
                       <li>
                       <a className="linkedin" href="/"><img  alt="linkedin" height="50px" width="50px" src={linkedin}/></a>
             
              <a className="linkedin" href="/"> <img alt="twitter" height="50px" width="50px" src={twitter}/></a>
